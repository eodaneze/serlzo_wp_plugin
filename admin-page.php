                            ...
                            <div class="dash-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <g fill="none">
                                        ...
                                        <path fill="currentColor" d="M15.519 8.482a.917.917 0 0 1 0-1.297l-1.061-1.06a2.417 2.417 0 0 0 0 3.418zm1.296 0a.917.917 0 0 1-1.297 0l-1.06 1.06a2.417 2.417 0 0 0 3.417 0zm0-1.297a.917.917 0 0 1 0 1.297l1.06 1.06a2.417 2.417 0 0 0 0-3.417zm1.06-1.06a2.417 2.417 0 0 0-3.417 0l1.06 1.06a.917.917 0 0 1 1.297 0z" opacity="0.5" />
                                        <path stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="M22 14.993c-.064 2.794-.33 4.426-1.446 5.541C19.088 22 16.73 22 12.01 22s-7.078 0-8.544-1.466S2 16.71 2 11.99s0-7.078 1.466-8.544C4.58 2.33 6.213 2.064 9.007 2" opacity="0.5" />
                                    </g>
                                </svg>
                            </div>
                            <div class="dash-nav-title">
    ...
    <section class="all-dashbaord">
        <div class="dashboard-content">
            ...
            <div class="dashboard-right">
                ...
                <!-- =============== main-body section ================== -->
                 <section class="all-dash-body">
                    <div class="dash-body-navigator">
                            <label>Home</label>
                        <div id="body-navigator" class="body-navigator">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24">
                                ...
                                <g fill="none" stroke="currentColor" stroke-width="2">
                                    ...
                                    <g opacity="0">
                                        ...
                                        <use href="#SVGf9bFLczd" transform="rotate(60 12 12)" />
                                        <use href="#SVGf9bFLczd" transform="rotate(120 12 12)" />
                                        <use href="#SVGf9bFLczd" transform="rotate(180 12 12)" />
                                        <use href="#SVGf9bFLczd" transform="rotate(240 12 12)" />
                                        <use href="#SVGf9bFLczd" transform="rotate(300 12 12)" />
                                        <set fill="freeze" attributeName="opacity" begin="0.9s" to="1" />
                                        <animateTransform attributeName="transform" dur="8s" repeatCount="indefinite" type="rotate" values="0 12 12;360 12 12" />
                                    </g>
                                </g>
                            </svg>
                            <label>Settings</label>
                        ...
                        <div id="setting-items" class="setting-items">
                           
                            <div class="setting-header" data-bs-toggle="modal" data-bs-target="#editModal">
                                <label>Connect Api</label>
                            </div>
                        </div>
                    </div>
                 </section>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editModalLabel">Connect Api</h1>
      ...
      <div class="modal-body"> 
        ...
        <form action="">
            ...
            <div class="input-group-cta">
                <button class="main-btn">Validate</button>
            </div>
        </form>
